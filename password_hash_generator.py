...
users = [
    ...
    UserAccount('techcorp.hr', 'uNw5bRyxeM'),
    UserAccount('healthcare.hr', 'BwrbwsfFIe'),
    UserAccount('edusoft.hr', 'zVGtMdNhbb'),
    UserAccount('greenenergy.hr', 'zYqEzchzRR'),
    UserAccount('agrifoods.hr', 'XTDQQ8SoCc'),
